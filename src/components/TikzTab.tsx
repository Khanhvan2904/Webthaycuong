    ...
    <div className="w-full relative">
            ...
            <div className="p-6 space-y-6">
              ...
              {(activeTab === AppTab.BBT || activeTab === AppTab.GRAPH) && (
                <div className="space-y-2">
                  <label className="text-xs font-bold text-teal-700 uppercase tracking-widest">Loại hàm số</label>
                  <select 
                    value={funcType} 
                    onChange={(e) => setFuncType(e.target.value as FunctionType)}
                    className="w-full px-4 py-3 rounded-xl border-2 border-slate-200 bg-white focus:border-teal-500 outline-none transition-all font-medium text-sm"
                  >
              ...
              {activeTab === AppTab.GEOMETRY && (
                <div className="space-y-2">
                  <label className="text-xs font-bold text-teal-700 uppercase tracking-widest">Loại hình học</label>
                  <select 
                    value={geoType} 
              ...
              {(activeTab === AppTab.AI_DRAW || activeTab === AppTab.CHEMISTRY) && (
                <div className="space-y-4">
                  <div className="flex flex-wrap gap-2">
                    {AI_SAMPLES[activeTab]?.map((sample, i) => (
                      <button 
                        ...
                        className="px-3 py-1 text-[10px] font-bold bg-slate-100 border border-slate-200 rounded-full hover:border-teal-500 transition-colors"
                      >
                        {sample.label}
                      </button>
                    ))}
                  ...
                  <textarea 
                    ...
                    className="w-full h-32 p-4 rounded-xl border-2 border-slate-200 bg-white text-sm focus:border-teal-500 outline-none"
                  />
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="bg-white rounded-2xl shadow-sm border border-slate-200 flex flex-col min-h-[500px] overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-200 flex items-center justify-between bg-slate-50/50">
              <h2 className="font-bold flex items-center gap-2 text-slate-700 uppercase text-xs tracking-widest">
            ...
            <textarea
              ...
              className="flex-1 w-full p-6 font-mono text-sm bg-slate-50 border-none resize-none focus:outline-none text-emerald-600 custom-scrollbar"
      ...
      {previewImage && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-md">
          <div className="bg-white rounded-3xl shadow-2xl max-w-4xl w-full flex flex-col overflow-hidden animate-in fade-in zoom-in duration-300">
            ...
            <div className="p-10 bg-white flex items-center justify-center min-h-[400px] overflow-auto">
              <img 
